...
CREATE TABLE IF NOT EXISTS public.portfolio_items (
  ...
  category VARCHAR(50) NOT NULL CHECK (category IN ('development', 'design', 'teaching')),
...
CREATE INDEX IF NOT EXISTS idx_portfolio_display_order ON public.portfolio_items(display_order);
...
CREATE TABLE IF NOT EXISTS public.admin_settings (
  ...
  -- Portfolio Info
  portfolio_title VARCHAR(255) NOT NULL DEFAULT 'Hansco Dev',
  portfolio_description TEXT,
  portfolio_subtitle VARCHAR(255),
  
  -- Admin Email
  admin_email VARCHAR(255) NOT NULL,
  
  -- Branding
  primary_color VARCHAR(7) DEFAULT '#10b981', -- Emerald
  accent_color VARCHAR(7) DEFAULT '#0ea5e9', -- Cyan
...
INSERT INTO public.portfolio_categories (name, display_name, description, color, display_order)
VALUES 
...
CREATE TABLE IF NOT EXISTS public.admin_logs (
  ...
  entity_type VARCHAR(50), -- portfolio_item, settings, etc
  entity_id UUID,
